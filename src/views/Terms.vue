<template>
  <div class="terms">
    ...
    <p>Welcome to Vs Code Google Calendar!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Vs Code Google Calendar's Website, located at
      https://light-haven-315312.web.app/.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Vs Code Google Calendar if you do not agree to take
    ...
    <p>
      We employ the use of cookies. By accessing Vs Code Google Calendar, you
      agreed to use cookies in agreement with the Vs Code Google Calendar's
      Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Vs Code Google Calendar and/or its licensors own
      the intellectual property rights for all material on Vs Code Google
      Calendar. All intellectual property rights are reserved. You may access
      this from Vs Code Google Calendar for your own personal use subjected to
      restrictions set in these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Vs Code Google Calendar</li>
      <li>Sell, rent or sub-license material from Vs Code Google Calendar</li>
      <li>
        Reproduce, duplicate or copy material from Vs Code Google Calendar
      </li>
      <li>Redistribute content from Vs Code Google Calendar</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Vs Code Google
      Calendar does not filter, edit, publish or review Comments prior to their
      presence on the website. Comments do not reflect the views and opinions of
      Vs Code Google Calendar,its agents and/or affiliates. Comments reflect the
      views and opinions of the person who post their views and opinions. To the
      extent permitted by applicable laws, Vs Code Google Calendar shall not be
    ...
    <p>
      Vs Code Google Calendar reserves the right to monitor all Comments and to
    ...
    <p>
      You hereby grant Vs Code Google Calendar a non-exclusive license to use,
    ...
    <p>
      ...
      hyperlink compensates the absence of Vs Code Google Calendar; and (d) the
    ...
    <p>
      ...
      e-mail to Vs Code Google Calendar. Please include your name, your
    ...
    <p>
      No use of Vs Code Google Calendar's logo or other artwork will be allowed
