<template>
  <div class="privacy">
    <h1>Privacy Policy for Vs Code Google Calendar</h1>

    <p>
      At Vs Code Google Calendar, accessible from
      https://light-haven-315312.web.app/, one of our main priorities is the
      privacy of our visitors. This Privacy Policy document contains types of
      information that is collected and recorded by Vs Code Google Calendar and
      how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Vs Code Google Calendar. This policy is not applicable
    ...
    <p>
      Vs Code Google Calendar follows a standard procedure of using log files.
    ...
    <P
      ...
      advertising partners of Vs Code Google Calendar.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Vs Code Google Calendar, which are
    ...
    <p>
      Note that Vs Code Google Calendar has no access to or control over these
    ...
    <p>
      Vs Code Google Calendar's Privacy Policy does not apply to other
    ...
    <p>
      Vs Code Google Calendar does not knowingly collect any Personal
